...
A DaVinci Resolve Fusion utility script for managing FX shots.
...
To update the script to the latest version, navigate to the folder for your operating system, pull the latest changes, and update the dependencies:
...
Run the tool inside DaVinci Resolve via:
- **Workspace** -> **Scripts** -> **Utility** -> **FxShotManager**
